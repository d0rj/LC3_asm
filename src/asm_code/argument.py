...
class Argument:
    ...
    Attributes:
        type_ (str): An argument type. Can be one of :class:`utils.lc3_constants.TokenType`.
    ...
    def __init__(self, type_: str, value) -> None:
        ...
        Note:
            ...
            but to create objects of this class using a static method :meth:`Argument.fromTree`.
    ...
    def fromTree(cls, argument: Tree):
        ...
        Args:
            argument (lark.Tree): Tree object with argument representation, builded from parser.

        Returns:
            (Argument | None): Returns constructed :class:`Argument` object; or
                `None` if argument type not supported.
