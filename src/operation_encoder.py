...
class OperationEncoder:
	...
	def _and_add_base(self, arguments: List[Dict[str, list]], op_name: str) -> int:
	...
	def _trap_subops_base(self, arguments: List[Dict[str, list]], op_name: str) -> int:
		required_argument_types(arguments, [], op_name)

		return self._operations[op_name]


	def ADD(self, arguments: List[Dict[str, list]]) -> int:
		return self._and_add_base(arguments, 'add')


	def AND(self, arguments: List[Dict[str, list]]) -> int:
		return self._and_add_base(arguments, 'and')


	def LD(self, arguments: List[Dict[str, list]]) -> int:
		return self._register_pcoffset9_base(arguments, 'ld')


	def ST(self, arguments: List[Dict[str, list]]) -> int:
		return self._register_pcoffset9_base(arguments, 'st')


	def LDI(self, arguments: List[Dict[str, list]]) -> int:
		return self._register_pcoffset9_base(arguments, 'ldi')


	def STI(self, arguments: List[Dict[str, list]]) -> int:
		return self._register_pcoffset9_base(arguments, 'sti')


	def LDR(self, arguments: List[Dict[str, list]]) -> int:
		return self._register_base_offset_base(arguments, 'ldr')


	def STR(self, arguments: List[Dict[str, list]]) -> int:
		return self._register_base_offset_base(arguments, 'str')


	def LEA(self, arguments: List[Dict[str, list]]) -> int:
		return self._register_pcoffset9_base(arguments, 'lea')


	def BR(self, arguments: List[Dict[str, list]]) -> int:
		return self._base_BR(arguments, 'br')


	def BRN(self, arguments: List[Dict[str, list]]) -> int:
		return self._base_BR(arguments, 'brn')


	def BRZ(self, arguments: List[Dict[str, list]]) -> int:
		return self._base_BR(arguments, 'brz')


	def BRP(self, arguments: List[Dict[str, list]]) -> int:
		return self._base_BR(arguments, 'brp')


	def BRNZ(self, arguments: List[Dict[str, list]]) -> int:
		return self._base_BR(arguments, 'brnz')


	def BRNP(self, arguments: List[Dict[str, list]]) -> int:
		return self._base_BR(arguments, 'brnp')


	def BRZP(self, arguments: List[Dict[str, list]]) -> int:
		return self._base_BR(arguments, 'brzp')


	def BRZNP(self, arguments: List[Dict[str, list]]) -> int:
	...
	def GETC(self, arguments: List[Dict[str, list]]) -> int:
		return self._trap_subops_base(arguments, 'getc')


	def OUT(self, arguments: List[Dict[str, list]]) -> int:
		return self._trap_subops_base(arguments, 'out')


	def PUTS(self, arguments: List[Dict[str, list]]) -> int:
		return self._trap_subops_base(arguments, 'puts')


	def IN(self, arguments: List[Dict[str, list]]) -> int:
		return self._trap_subops_base(arguments, 'in')


	def PUTSP(self, arguments: List[Dict[str, list]]) -> int:
		return self._trap_subops_base(arguments, 'putsp')


	def HALT(self, arguments: List[Dict[str, list]]) -> int:
